...
const PurchaseOrderInfoLeftPart = ({ className, purchaseOrderDetails }) => {
  return (
...
const PurchaseOrderInfoRightPart = ({ className, purchaseOrderDetails }) => {
...
const PurchaseOrderDetailsSection = ({ purchaseOrderDetails }) => {
  return (
...
const VendorDetails = ({ purchaseOrderDetails }) => {
  return (
    <div className="w-full lg:p-6 p-4 rounded-xl border-[1.5px] border-[#E8E8E8]">
      <h2 className="2xl:text-3xl xl:text-2xl lg:text-xl md:text-base text-sm font-semibold text-[#4A4A4A] mb-4">
        Vendor Details
      ...
      <div className="space-y-5 lg:grid-cols-2 grid grid-cols-1 text-sm text-gray-600">
        <div>
          <p className="font-medium text-[#777777] xl:text-base md:text-sm text-xs ">
            Vendor Name
          </p>
        ...
        <div>
          ...
          <span className="text-[#4A4A4A] font-medium xl:text-lg md:text-base text-sm">
            {purchaseOrderDetails?.contact_no}
          </span>
        </div>
        {/* <div>
          <p className="font-medium text-[#777777] xl:text-base md:text-sm text-xs ">
...
const RelatedDocuments = ({ purchaseOrderDetails }) => {
  const [files, setFile] = useState(
    purchaseOrderDetails?.po_url &&
      purchaseOrderDetails?.po_url[0].invoice_url != "N/A"
      ? purchaseOrderDetails?.po_url
      : []
  );
...
const Description = ({ purchaseOrderDetails }) => {
  return (
    <div className="w-full lg:p-6 p-4 rounded-xl border-[1.5px] border-[#E8E8E8]">
      <h2 className="2xl:text-3xl xl:text-2xl lg:text-xl md:text-base text-sm font-semibold text-[#4A4A4A] mb-4">
        Description
